...
LEAVE_REASON, VACATION_REASON, PENALTY_MENU, SELECT_PENALTY_TYPE, ENTER_PENALTY_DETAILS, SELECT_EMPLOYEE_FOR_PENALTY, CONFIRM_PENALTY, EDIT_PENALTY_AMOUNT, SELECT_PENALTY_TO_EDIT, EDIT_PENALTY_CUSTOM_AMOUNT, SELECT_EMPLOYEE_FOR_VIEW = range(12)
